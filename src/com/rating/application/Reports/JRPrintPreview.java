package com.rating.application.Reports;
...
public class JRPrintPreview extends VBox {
    private static final int REPORT_DPI_RESOLUTION = 72;
    ...
    private ToggleButton btnActualSize = new ToggleButton();
    private ToggleButton btnFitPage = new ToggleButton();
    private ToggleButton btnFitWidth = new ToggleButton();
    ...
    private ComboBox<String> cmbZoom = new ComboBox<>();
    private Label lblStatus = new Label();
    private VBox vBoxPage = new VBox();
    private HBox statusBar = new HBox();
    private ScrollPane scrollPane = new ScrollPane();
    private ToolBar toolBar = new ToolBar();
    private TextField txtGoTo = new TextField();
    ...
    private JRPrintPreview(JasperPrint jasperPrint, ResourceBundle resBundle) {
        this(DefaultJasperReportsContext.getInstance(), jasperPrint, resBundle);
    }

    private JRPrintPreview(JasperReportsContext jasperReportsContext, JasperPrint jasperPrint, ResourceBundle resBundle) {
    ...
    private void initResources(ResourceBundle resBundle) {
        if (resBundle == null)
    ...
    private void initComponents() {
        ...
        vBoxPage.setStyle("-fx-background-color: transparent");
        ...
        getChildren().addAll(toolBar, scrollPane, statusBar);
